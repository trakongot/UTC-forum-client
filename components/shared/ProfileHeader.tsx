...
function ProfileHeader({
  ...
  return (
    <div className="bg-light-1 flex w-full flex-col justify-start px-4 py-5 rounded-xl border shadow-md">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-base-medium dark:text-gray-1">@{username}</p>
          </div>
        </div>
