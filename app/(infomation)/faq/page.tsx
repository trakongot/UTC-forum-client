...
function FAQ() {
  ...
  return (
    <ScrollArea className="mx-auto h-[800px] p-24">
      <div className="mb-16">
        <h1 className="text-3xl font-manrope text-center font-bold text-gray-900 leading-[3.25rem]">
      ...
      <div className="accordion-group" data-accordion="default-accordion">
        {faqItems.map((item, index) => (
          <div
            key={index}
            className="accordion py-6 px-6 border-b border-solid border-gray-200 transition-all duration-500 rounded-2xl hover:bg-indigo-50 accordion-active:bg-indigo-50"
          >
            <button
            ...
            <div
              ...
              className={`accordion-content w-full px-0 overflow-hidden transition-all duration-500 ${activeIndex === index ? "max-h-[250px] py-4" : "max-h-0 py-0"}`}
